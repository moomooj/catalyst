                  ...
                  >
                    ...
                    {isBusy && (
                      <div className="absolute bottom-2 flex flex-col items-center gap-0.5">
                        <span className="block text-[6px] font-bold uppercase md:text-[7px]">Booked</span>
                        <div className="hidden md:flex items-center gap-1">
                          <div className={`h-1 w-1 rounded-full ${eventInfo?.dotColor}`} />
                          <span className="text-[8px] font-bold uppercase tracking-tighter">{eventInfo?.label}</span>
                        </div>
                      </div>
                    )}
                  </button>
