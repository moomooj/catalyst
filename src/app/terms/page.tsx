    ...
    <main className={`${raleway.className} bg-[#FDFCFB] text-[#1A1A1A] w-full min-h-screen pt-32 md:pt-48 pb-16 md:pb-32 px-6`}>
      <div className="max-w-4xl mx-auto border border-[#D6CAB7] p-8 md:p-16 bg-white shadow-sm">
        ...
        <div className="space-y-8 text-justify text-[11px] leading-[1.5]">
          <section>
            <h2 className="font-bold mb-2 text-[#303520]">1. LOREM IPSUM DOLOR</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold mb-2 text-[#303520]">2. CONSECTETUR ADIPISCING ELIT</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold mb-2 text-[#303520]">3. SED DO EIUSMOD TEMPOR</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold mb-2 text-[#303520]">4. INCIDIDUNT UT LABORE</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold mb-2 text-[#303520]">5. ET DOLORE MAGNA ALIQUA</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold mb-2 text-[#303520]">6. UT ENIM AD MINIM VENIAM</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold mb-2 text-[#303520]">9. UT ALIQUIP EX EA COMMODO</h2>
            <p>
          ...
          <section>
            <h2 className="font-bold mb-2 text-[#303520]">10. DUIS AUTE IRURE DOLOR</h2>
            <p>
