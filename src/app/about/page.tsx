...
export const metadata = {
  ...
  description: "Our story, philosophy, and commitment to refined event mixology.",
};
          ...
          <div className="grid gap-20 md:grid-cols-12 md:items-center">
            ...
            <div className="md:col-span-6 md:pl-10">
              <h2 className="text-3xl font-light leading-relaxed md:text-5xl">
                Founded on the belief that <span className="text-[#7C826F]">hospitality</span> is an art form.
              </h2>
              <p className="mt-10 text-lg leading-relaxed text-[#7C826F]">
                Catalyst Mobile Bar was born to elevate celebrations through refined visual storytelling 
                and flawless execution. We don't just set up a bar; we create a destination 
                within your event—a space where guests feel cared for and every detail 
                is intentionally considered.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-32 md:py-48">
        <div className="grid gap-16 md:grid-cols-3">
          <div className="space-y-6">
            <span className="text-xs font-bold tracking-widest text-[#D6CAB7]">01</span>
            <h3 className="text-2xl font-light tracking-tight">Editorial Standard</h3>
            <p className="text-base leading-relaxed text-[#7C826F]">
              Every setup is styled with premium visual restraint. We believe in 
              "quiet luxury"—where the bar complements your aesthetic rather than 
              competing with it.
            </p>
          </div>
          <div className="space-y-6">
            <span className="text-xs font-bold tracking-widest text-[#D6CAB7]">02</span>
            <h3 className="text-2xl font-light tracking-tight">Regional Lens</h3>
            <p className="text-base leading-relaxed text-[#7C826F]">
              We integrate seasonal BC ingredients to create cocktail programs that 
              feel fresh and regional. Our menu changes with the landscape of 
              the Pacific Northwest.
            </p>
          </div>
          <div className="space-y-6">
            <span className="text-xs font-bold tracking-widest text-[#D6CAB7]">03</span>
            <h3 className="text-2xl font-light tracking-tight">Service Precision</h3>
            <p className="text-base leading-relaxed text-[#7C826F]">
              Behind every elegant moment is disciplined prep. We handle the 
              complexities of licensing and logistics so you can remain 
      ...
      <section className="border-t border-[#D6CAB7]/30 px-6 py-32 bg-[#FDFCFB]">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 md:grid-cols-2">
            <div>
              <h2 className="text-3xl font-light md:text-4xl">Where We Serve</h2>
              <p className="mt-6 text-base leading-relaxed text-[#7C826F]">
                ...
                adapting to diverse venues, from private residences to 
                remote outdoor landscapes.
              </p>
            </div>
            <div className="flex flex-col justify-center">
              <div className="space-y-2">
                <p className="text-sm font-semibold text-[#303520]">Licensed & Insured</p>
                <p className="text-sm text-[#7C826F]">Serving It Right Certified · Full Liability Coverage</p>
              </div>
              <div className="mt-8 h-px w-full bg-[#D6CAB7]/30" />
              <div className="mt-8 space-y-2">
                <p className="text-sm font-semibold text-[#303520]">BC Registered Business</p>
                <p className="text-sm text-[#7C826F]">Committed to local excellence and professional standards.</p>
              </div>
            </div>
          </div>
        </div>
